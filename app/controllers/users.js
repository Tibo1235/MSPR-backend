...
const userController = {
    ...
    validateRequest: async (req, res, next, roles) => {
        ...
        try {
            const decodedToken = jsonwebtoken_1.default.verify(token, config_json_1.jwt_secret);
